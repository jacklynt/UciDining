...
public class anteateryLateNightActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_anteatery_late_night);
    ...
    private class prepareListData extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            String url = "https://uci.campusdish.com/Commerce/Catalog/Menus.aspx?LocationId=3056&PeriodId=108";
            Document doc = null;
            try {
    ...
    public void callMethods() {
        ExpandableListView expListView = (ExpandableListView) findViewById(R.id.latenight_menu);
