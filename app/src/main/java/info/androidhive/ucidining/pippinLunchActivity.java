...
public class pippinLunchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pippin_lunch);
    ...
    private class prepareListData extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            String url = "https://uci.campusdish.com/Commerce/Catalog/Menus.aspx?LocationId=4832&PeriodId=106";
            Document doc = null;
            try {
    ...
    public void callMethods() {
        ExpandableListView expListView = (ExpandableListView) findViewById(R.id.lunch_menu);
