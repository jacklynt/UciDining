...
public class pippinDinnerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pippin_dinner);
    ...
    private class prepareListData extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            String url = "https://uci.campusdish.com/Commerce/Catalog/Menus.aspx?LocationId=4832&PeriodId=107";
            Document doc = null;
            try {
            ...
            String diningHall = "pippin";

            List<String> categoriesList = new ArrayList<String>();
            if (diningHall.equals("pippin")) {
                categoriesList = new ArrayList<String>(Arrays.asList("Desserts", "Deli","Grill", "Main Line", "Salad Bar", "Saute", "Soups", "Destination", "Fresh & Healthy", "Pizza"));
            } else {
    ...
    public void callMethods() {
        ExpandableListView expListView = (ExpandableListView) findViewById(R.id.dinner_menu);
