...
public class pippinBreakfastActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pippin_breakfast);
    ...
    private class prepareListData extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            String url = "https://uci.campusdish.com/Commerce/Catalog/Menus.aspx?LocationId=4832&PeriodId=49";
            Document doc = null;
            try {
