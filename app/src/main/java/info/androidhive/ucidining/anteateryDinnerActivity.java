...
public class anteateryDinnerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_anteatery_dinner);
    ...
    private class prepareListData extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            String url = "https://uci.campusdish.com/Commerce/Catalog/Menus.aspx?LocationId=3056&PeriodId=107";
            Document doc = null;
            try {
